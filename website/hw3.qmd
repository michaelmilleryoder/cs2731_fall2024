...
**Due 2024-10-28, 11:59pm**. *Instructions last updated 2024-10-16.*
...
2. Perplexity values for bigram, trigram and fourgram character-level language models, on each test file (*New York Times* article and Shakespeare sonnets). For each file, calculate the perplexity for each line and report the average across all lines in the document.
3. What does your perplexity indicate in different test data? What does a comparison of different *n* in the n-grams in terms of perplexity tell you? Which performs best? Why do you think your models performed the way they did?
