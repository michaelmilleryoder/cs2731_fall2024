...
3. **Project proposal and literature review**. *Due 10-17*. Please submit one per group on Canvas. This proposal will be a report with answers to the following questions:
...
3. **Project peer review**. *Due 11-07*. In a form, you will rate your own performance and the performance of other group members. This feedback will not be used for grading, but to identify any workload distribution issues early on and assign roles accordingly.
...
* Build networks of charaters and predict relations among characters in fiction using this [dataset](https://github.com/dbamman/characterRelations).
