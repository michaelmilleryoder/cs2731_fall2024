...
## Deliverables
1. **Project idea submission**. This form asks for project ideas. about NLP research areas of interest, skills, project ideas, and any group preferences. It is used by the instructor and TA to match groups with similar project interests and complementary abilities. Stay tuned to this page for more details!
1. **Project idea ranking and survey**. In a form, students will rank which project ideas they would prefer to work on in a group, as well as list any personnel preferences. Teaching staff will take all of this information into account when assigning groups.
2. **Project pre-proposal form**. In a Google Form, you will provide the type of contribution your group is interested in pursuing, as well as more specificity on the project idea. Please submit one form per group on Canvas. Teaching staff will provide some feedback and guidance on this direction in meetings.
3. **Project proposal and literature review**. Please submit one per group on Canvas. This proposal will be a report with answers to the following questions:
...
3. **Project peer review**. In a form, you will rate your own performance and the performance of other group members. This feedback will not be used for grading, but to identify any workload distribution issues early on and assign roles accordingly.
5. **Progress report**. A brief (max 3 pages) progress report of a basic working system. Not everything needs to be done or fully functional, but there needs to be some sort of basic functionality. Also list any questions you have or resources you will need to successfully complete the project by the final deadline. This report should be in the ACL format that the final report will be in.
