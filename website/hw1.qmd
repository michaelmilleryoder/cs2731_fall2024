...
**Due 2024-09-19, 11:59pm**. *Instructions last updated 2024-09-04.*
...
<!--* <a id="raw-url" href="https://raw.githubusercontent.com/michaelmilleryoder/cs2731_fall2024/main/docs/hw1/skeleton.py">Skeleton Python code</a>. You will need to have a Python environment with scipy and numpy packages. Some functions are stubs in the python code. You will need to fill them out.-->
* <a href="hw1/skeleton.py" download="download">Skeleton Python code</a>. You will need to have a Python environment with scipy and numpy packages. Some functions are stubs in the python code. You will need to fill them out.
...
Please submit all of this material on Canvas as individual files. Do **not** submit a zip file. Only files with .pdf, .txt, or .py file extensions will be accepted. We will grade your report and look over your code.
