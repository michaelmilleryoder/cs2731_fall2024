---
title: "CS 2731 Introduction to Natural Language Processing<br/>Fall 2024"
template-partials:
    - title_block.html
...
![](img/peter_miller_communication_cropped.png)
...
<table>
	...
	<tbody style="text-align:left">
		...
		<tr>
			...
			<td>mmyoder@pitt.edu or through Canvas messages</td>
		</tr>
		<tr>
...
<table class="schedule">
    ...
    <tbody>
        ...
        <tr style="background-color:#cccccc">
            <td>14</td>
            <td>10-14 M</td>
            <td style="font:italic">Fall Break. No class.<a href="slides/session14_cs2731_spring2024.pdf">Transformers part 2, pretraining, BERT and GPT</a></td>
