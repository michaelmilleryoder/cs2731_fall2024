...
**Due 2024-11-07, 11:59pm**. *Instructions last updated 2024-10-24.*
...
See chapter 17 in the Jurafsky & Martin textbook for details on the Viterbi algorithm.
...
You can do this part by hand. No implementation is required.
...
Copy this [skeleton Colab notebook](https://colab.research.google.com/drive/1tYlzGcBdTKcdjDfB8VyuAvvo4gqbIl-i?usp=sharing), run the cells, and fill in the places that are specified.

If you run out of Google Colab resources, you will have to wait until later to run the notebook. Email Dhanush and/or Michael to ask if you have extension days still available to use as this is the last assignment to use them. If you don't, we can provide more for this case.
...
4. A link to your copied and filled out Colab notebook. **Please set the Colab document sharing to public viewing so that teaching staff can see it for grading.**
